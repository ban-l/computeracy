...
-- 获取锁（乐观锁方式）
INSERT INTO distributed_lock (lock_name, lock_owner, acquired_at, expires_at)
VALUES ('order_processing', 'server1', NOW(), DATE_ADD(NOW(), INTERVAL 30 SECOND))
ON DUPLICATE KEY UPDATE 
    lock_owner = IF(expires_at < NOW(), VALUES(lock_owner), lock_owner),
